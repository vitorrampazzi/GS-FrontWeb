...
import profilesData from '@/data/profiles.json'; // Importa os dados

// Esta função encontra o perfil com base no ID da URL
function getProfile(id) {
  // params.id é sempre uma string, então comparamos com o id (que é número)
...
export default function ProfilePage({ params }) {
  ...
  // (Este JSX é o mesmo do seu Modal.jsx, mas adaptado para uma página)
  return (
